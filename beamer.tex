...
\begin{document}
	...
	\begin{frame}{What this is}
		\begin{itemize}
			...
			\item Average marginal effects: the expected change in predicted output for a one-unit change in each feature, averaged across all observations.
			\item Standard errors obtained via \textbf{nonparametric bootstrap} --- no distributional assumptions required.
