...
\midrule
bias        & 0.0126 & $-$0.0018 & $-$0.0157 \\
std.\ error & 0.0608 & 0.0227 & 0.0074 \\
bias / s.e. & 0.21 & 0.08 & \keynum{2.11} \\
\bottomrule
\end{tabular}
\vskip1ex
\raggedright
At $n = 5{,}000$ the half-width of the interval (0.0143) is smaller than the
bias (0.0157). XGBoost, whose bias \emph{does} vanish with $n$, never fails in
that direction --- so the failure is specific to learners whose
