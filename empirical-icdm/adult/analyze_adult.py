...
Results saved to empirical/adult/results/.
...
# ---------------------------------------------------------------------------
# Feature groups
# (imported from processed data directory)
# ---------------------------------------------------------------------------

sys.path.insert(0, os.path.join(PAPER_DIR, 'data', 'processed', 'adult'))
...
if __name__ == '__main__':
    print("=" * 60)
    print("marginfx Empirical Analysis — UCI Adult Income")
    print("=" * 60)
    print(f"\nSettings:")
